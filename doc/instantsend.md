...
This mechanism has been integrated into Bitcore-Node-TOUR which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TourcoinGroup/insight-api-tour#web-socket-api](https://github.com/TourcoinGroup/insight-api-tour#web-socket-api)
* API: [https://github.com/TourcoinGroup/insight-api-tour#instantsend-transactions](https://github.com/TourcoinGroup/insight-api-tour#instantsend-transactions)
...
By default, the TOUR Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TOUR Core daemon:
