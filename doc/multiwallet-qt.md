...
Only requiring some minor changes is tour.cpp.
...
Changes to tour.cpp
----------------------
tour.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
