 ...
 *
 *   // network
 *   CTOURNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.tour.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CTOURNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: TOURNetwork
// //   -- signature requirements : Key1(User)
// class CTOURNetworkVariable : public CGovernanceObject
// {
// private:
