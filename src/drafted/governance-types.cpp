...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "TOURNetwork") type = TOURNetwork;
    if(strType == "TOURNetworkVariable") type = TOURNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == TOURNetwork) s = "TOURNetwork";
    if(type == TOURNetworkVariable) s = "TOURNetworkVariable";
