...
//
// The Masternode Class. For managing the Darksend process. It contains the input of the 500TOUR, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 500 TOUR - checking if valid masternode)
