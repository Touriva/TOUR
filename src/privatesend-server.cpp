...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all TOUR related functionality
...
/*
    ...
    allow endless transaction that would bloat TOUR and make it unusable. To
