    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("TOUR Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TOUR address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tour: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About TOUR Core"), this);
    aboutAction->setStatusTip(tr("Show information about TOUR Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TOUR Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TOUR addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TOUR addresses"));
    ...
    openAction->setStatusTip(tr("Open a tour: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TOUR Core help message to get a list with possible TOUR Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("TOUR Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TOUR network", "", count));
    } else {
...
{
    QString strTitle = tr("TOUR Core"); // default title
