    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("TOUR-light"), QVariant("light"));
    ui->theme->addItem(QString("TOUR-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("TOUR-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("TOUR-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("TOUR-traditional"), QVariant("trad"));
