    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("TOUR Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About TOUR Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  tour-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the TOUR in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 TOUR, 0.1 TOUR, 1 TOUR and 10 TOUR -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://www.tourcoin.org/PrivateSend\">https://www.tourcoin.org/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("TOUR Core is shutting down...") + "<br /><br />" +
